...
import { ScrollView, VStack, HStack, Menu, Pressable, HamburgerIcon, IconButton, Icon, Text, FormControl, CheckIcon, NativeBaseProvider, Input, Center, Box, StatusBar, Heading, Select, Button, Image} from "native-base";
      ...
      <VStack space={10} alignItems="center">
        <Center w="95%">
          ...
          <VStack alignItems="center">
            ...
            <Input multiline fontWeight={"bold"} w={"60%"}  h="60" fontSize="xl">Naproxeno</Input>
          </HStack>
        </Center>
        <Center w="95%">
          <HStack space="2" alignItems="center">            
            <Text  fontWeight={"bold"} fontSize="lg">Motivo:</Text>  
            <Input fontWeight={"bold"} w={"70%"}  h="70" multiline fontSize="xl">Resfriado activo</Input>
          </HStack>
        </Center>
        <Center w="95%">
          <HStack space="2" alignItems="center">
        ...
        <Center w="95%">
          <HStack space="2" alignItems="center">            
            ...
            <Input fontWeight={"bold"} w={"70%"}  h="60" multiline fontSize="xl">1 Tableta cada 24hrs</Input>
          </HStack>
        </Center>
