      ...
      <VStack space={8} alignItems="center">
        <Center w="95%">
          ...
          <VStack alignItems="center">
            ...
            <Input fontWeight={"bold"} w={"60%"}  h="81" fontSize="xl">Ej. Quemadura 3er grado</Input>
          </HStack>
        </Center>
        <Center w="95%">
          <HStack space="2" alignItems="center">
        ...
        <Center w="95%">
          <HStack space="2" alignItems="center">            
            ...
            <Input multiline fontWeight={"bold"} w={"70%"}  h="90" fontSize="xl">Ej. Medicamente controlado, 3 dosis por día</Input>
          </HStack>
        </Center>
        <Center w="95%">
          <HStack space="2" alignItems="center">            
      ...
      <NativeBaseProvider>
        ...
        <Box>
          <Box borderWidth={3} borderRadius="xl" borderColor="info.800" alignSelf="center" bg="white" marginTop={4} width="95%" h="94%">
            ...
            <Heading fontSize={"2xl"} fontStyle="italic" marginBottom={4} textAlign="center">Modificar Incidente</Heading>
            <Form/>
          </Box>
        </Box>
      </NativeBaseProvider>
